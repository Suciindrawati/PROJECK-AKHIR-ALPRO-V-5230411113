...
kursor.execute("SELECT *FROM FAUNA WHERE asal = 'Sumatera' OR  jmlh_skrg <= '500'")
...
print("="*110)
print("{:<10} {:<20} {:<20} {:<20} {:<20} {:<20}".format("ID fauna", "nama fauna", "jenis", "asal", "jmlh skrg", "thn ditemukan"))
print("-"*110)
